namespace Async
{
  ...
  public static class AsyncPump
  {
    ...
    private sealed class SingleThreadSynchronizationContext : SynchronizationContext
    {
      ...
      {
        this.m_trackOperations = trackOperations;
      }
      ...
      {
        if (this.m_trackOperations)
          Interlocked.Increment(ref this.m_operationCount);
      }
      ...
      {
        if (this.m_trackOperations &&
            Interlocked.Decrement(ref this.m_operationCount) == 0)
          this.Complete();
      }
    }
  }
